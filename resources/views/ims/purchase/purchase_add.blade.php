            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="md-3">
                        ...
                        <i class="btn btn-dark btn-rounded waves-effect waves-light fas fa-plus-circle addeventmore"> Add More</i>
                    </div>
                </div>
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('purchase.store') }}">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-dark btn-rounded waves-effect waves-light" id="storeButton"> Purchase Store</button>
